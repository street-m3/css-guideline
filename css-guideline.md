...
特定のブロック(div, article, figure)に機能を持たせたい場合や詳細度を下げて抽象的に使いたい場合など、スコープ外に影響しないことを前提に活用したい。『セレクタ指定は極力避ける』
...
## 参考資料
[CSSとSassのコーディングスタイルガイドを作ってみた](https://qiita.com/manabuyasuda/items/5d83a5516051cc58a274)
